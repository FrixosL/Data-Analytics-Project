...
clean_data <- raw_data %>% 
  ...
  select(id, host_id, host_location, host_response_rate, host_is_superhost, host_acceptance_rate, host_listings_count,
         host_verifications, host_identity_verified, neighbourhood_group_cleansed, city, state, zipcode, latitude, longitude,
         property_type, room_type, accommodates, bathrooms, bedrooms, beds, bed_type, square_feet, price, weekly_price, monthly_price, 
         security_deposit, cleaning_fee, guests_included, extra_people, minimum_nights, maximum_nights, number_of_reviews,
         review_scores_rating, instant_bookable, cancellation_policy, prop_type_simplified, listing_url, is_location_exact)
...
model3 <- lm(price_4_nights ~ bathrooms + bedrooms + beds + accommodates, data = clean_data)
...
model4 <- lm(price_4_nights ~ prop_type_simplified + number_of_reviews + review_scores_rating + room_type + host_is_superhost, data = clean_data)
...
model5 <- lm(price_4_nights ~ prop_type_simplified + number_of_reviews + review_scores_rating + room_type + is_location_exact, data = clean_data)
...
model7 <- lm(price_4_nights ~ prop_type_simplified + number_of_reviews + review_scores_rating + room_type + cancellation_policy, data = clean_data)
